...
window.addEventListener('message', function(event) {
    ...
    if (event.data.type == "updateVehicleInfos") {
        ...
        $('#contentVehicle').append(`
                    ...
                    <div class="column spacebetween info">
                        <span class="title">Frenleme</span>
                        <div class="bar">
...
function testDrive(){
    $.post('http://esx_vehicleshop/TestDrive', JSON.stringify({vehicleModel: vehicleSelected.modelcar}));    
...
function openModalMenu(){    
    ...
    $('#closemenu').append(`
        ...
        <div class="modal-content">
            <p class="title">Satın Almayı Onaylıyor Musun:</p>
            <p class="vehicle">Araç Satın Alım</p>         

            <p>Brand: <span class="Kategori">`+vehicleSelected.brand+`</span></p>
    ...
    switch(event.which) {        
        ...
        case 1:
            ...
            if(!itemDisabled) {
                ...
                $.post("http://esx_vehicleshop/SpawnVehicle", JSON.stringify({ modelcar: dataCar[9].outerText, price: dataCar[7].outerText }));


                if (dataCar[7].outerText < 1) {
                    document.getElementById("buttonbuy").innerHTML = '<span class="sold-out-text">Tükendi</span>';
                }
            }
        break;
    }
